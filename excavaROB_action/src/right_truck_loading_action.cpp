...
class RightTruckLoadingAction
{
  private:
    TrajClient* traj_client_;

  public:
    RightTruckLoadingAction()
    {
    ...
    pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
    {
      ...
      goal.trajectory.points[ind].positions[3] = -0.25;
      ...
      goal.trajectory.points[ind].positions[1] = 0.45;
      goal.trajectory.points[ind].positions[2] = -0.55;
      goal.trajectory.points[ind].positions[3] = -0.25;
      ...
      goal.trajectory.points[ind].positions[2] = -0.75;
      goal.trajectory.points[ind].positions[3] = 1.66;
